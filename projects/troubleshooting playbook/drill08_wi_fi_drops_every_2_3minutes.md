...
🔑 Clues from this drill:
	• DHCP-Client:
		○ Event ID 1001: unable to renew address (timeout)
		○ Event ID 1002: DHCPNACK
	• 802.1X/EAP:
		○ Authentication failed due to timeout
		○ 802.1X supplicant restarting authentication
	• WLAN:
...
ping -t <DC_or_gateway>
	...
	• Confirm:
		○ No drops
		○ No repeating timeouts every 2–3 minutes
